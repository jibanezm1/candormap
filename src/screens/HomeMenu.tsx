      ...
      <ScrollView style={{ marginHorizontal: 30 }}>
        <Animated.View style={logoStyle}>
          <TouchableOpacity onPress={() => {
            ...
            <Text style={{ color: "#C889FF", fontSize: (Dimensions.get('screen').width > 320 ? 40 : 20) }}>Encuestas</Text>
          </TouchableOpacity>
        </Animated.View>
        <Animated.View style={logoStyle}>
          <TouchableOpacity onPress={() => {
            ...
            <Text style={{ color: "#DBDBDB", fontSize: (Dimensions.get('screen').width > 320 ? 40 : 20) }}>Perfil</Text>
          </TouchableOpacity>
        </Animated.View>
        <Animated.View style={logoStyle}>
          <TouchableOpacity onPress={() => {
            ...
            <Text style={{ color: "#DBDBDB", fontSize: (Dimensions.get('screen').width > 320 ? 40 : 20) }}>Pagos</Text>
          </TouchableOpacity>
        </Animated.View>
        <Animated.View style={logoStyle}>
          <TouchableOpacity onPress={() => {
            ...
            <Text style={{ color: "#DBDBDB", fontSize: (Dimensions.get('screen').width > 320 ? 40 : 20) }}>Contacto</Text>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.innerContainer}>
            <Image
              source={require('../assets/images_black/homeMenu.png')}
              resizeMode='contain'
              style={styles.image}
            />
          </View>
...
const styles = StyleSheet.create({
  container: {
    ...
    marginTop: Dimensions.get('screen').height * 0.30, // Margen superior del 5%F
